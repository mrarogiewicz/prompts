...
- **Insider Ownership & Recent Activity:**
  ...
  | **Significant Insider Transaction (Last 12 Mo.)**  | | |
  | **Leadership's Stated Strategic Priorities** | | |
...
| **Reddit** | | | |
| ** X **m| | | |
- **Sentiment Analysis** Compare the Seeking Alpha vs. Reddit vs X views and sentiment. Highlight any major disconnects. In one sentence
